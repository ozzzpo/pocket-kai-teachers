...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Portal>
    <ContextMenuPrimitive.Content
      ref={ref}
      className={cn(
        'z-50 min-w-[8rem]  bg-l-account-actions dark:bg-d-account-actions dark:text-white',
        'overflow-hidden rounded-[5px] border p-1 text-popover-foreground shadow-md',
